...
public class myDetailFragment extends BaseFragment implements View.OnClickListener{
    View mDeatilView;
    FragmentManager fm;
    LinearLayout me_head,me_nickname,me_phone,me_email,me_sex,me_height,me_weight,me_land,me_autograph;
    TextView tv_nickname,tv_phone,tv_sex,tv_height,tv_weight,tv_autograph,tv_email;
    private String sex;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ll_me_email:
                DialogUtility.DialogAutograph("email",getActivity(),tv_email);
                break;
            case R.id.ll_me_sex:
            ...
            case R.id.ll_me_autograph:
                DialogUtility.DialogAutograph("autograph",getActivity(),tv_autograph);
                break;
